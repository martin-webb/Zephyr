...
#define GAME_TITLE_END_ADDRESS 0x143 // NOTE: Yes, this is the same as CGB_FLAG_ADDRESS

#define CGB_FLAG_ADDRESS 0x143 // NOTE: Yes, this is the same as GAME_TITLE_END_ADDRESS
